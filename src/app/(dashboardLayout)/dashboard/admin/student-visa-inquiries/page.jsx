...
// ===================================================================
// Admin — Student Visa Inquiries queue
// Every /services/study-abroad submission lands here. Auto-generated
// STU-#### number, filter/search, inline status change, eye button
// for full details.
// ===================================================================
...
const inqNo = (id = "") => "STU-" + parseInt(id.slice(-6) || "0", 16).toString().padStart(6, "0");

export default function StudentVisaInquiriesPage() {
    ...
    const params = useMemo(() => {
        const p = { page, limit: 20, service: "student-visa" };
    ...
    const remove = async (id) => {
        if (!confirm("Delete this student visa inquiry?")) return;
        setBusyId(id);
        try {
        ...
        <div className="p-6 max-w-7xl mx-auto">
                ...
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-gray-500 mt-0.5">
                            Real-time queue of visitor student-visa requests.
                        </p>
                    </div>
                </div>
            ...
            {loading ? (
                ...
                <div className="py-24 text-center border border-dashed border-gray-200 rounded-2xl text-gray-500">
                    No student visa inquiries match this filter.
                </div>
            ) : (
...
function DetailModal({ it, onClose }) {
    ...
    const waHref = it.phone
        ? `https://wa.me/${it.phone.replace(/\D/g, "")}?text=${encodeURIComponent(`Hi ${it.name}, regarding your student visa inquiry ${inqNo(it._id)}...`)}`
        : null;
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50">
            <div className="bg-white rounded-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto shadow-2xl">
                ...
                <div className="p-5 space-y-5">
                    ...
                    <Section title="Trip">
                        <Row label="Visa type">Student</Row>
                    ...
                    <div className="flex flex-wrap gap-2 pt-2">
                        ...
                        {it.email && (
                            <a href={`mailto:${it.email}?subject=Re: Student Visa Inquiry ${inqNo(it._id)}`} className="inline-flex items-center gap-2 px-4 py-2.5 rounded-lg bg-brand-dark hover:bg-brand-dark-hover text-white text-sm font-bold">
